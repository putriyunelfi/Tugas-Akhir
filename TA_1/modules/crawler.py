...
#error
    res = requests.get('http://6nhmgdpnyoljh5uzr5kwlatx2u3diou4ldeommfxjz3wkhalzgjqxzqd.onion/', params={'q': query}) #memasukkan url yang akan di crawl # akses links.txt dari hasil github agus
